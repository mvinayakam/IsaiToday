              ...
              {user && (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem onClick={() => router.push('/my-posts')} data-testid="menu-my-posts">
                      <Music className="w-4 h-4 mr-2" />
                      My Posts
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => router.push('/my-likes')} data-testid="menu-my-likes">
                      <Heart className="w-4 h-4 mr-2" />
                      My Likes
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={() => signOut({ callbackUrl: '/' })} data-testid="button-logout">
