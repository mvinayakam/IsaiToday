...
interface SongOfDayData { song: Song; poster: User | null; }
...
export default function Home() {
    ...
    return (
      <div className="min-h-screen pt-16 md:pt-20 flex items-center justify-center">
        <div className="max-w-md mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Every song has a story — what&apos;s yours?</h1>
  ...
  return (
    <div className="min-h-screen pt-16 md:pt-20">
      {songOfDayData && (
        <SongOfTheDay song={songOfDayData.song} poster={songOfDayData.poster ?? undefined} story="" tags={[]} likes={0}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        <p className="text-muted-foreground mb-8">Add a song you love and tell everyone why it matters to you</p>
      </div>
